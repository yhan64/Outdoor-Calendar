// app actions
export const INITIALIZING_DATA = 'initializing-data'
export const DATA_INITIALIZED = 'data-initialized'
...
export const FETCHING_EVENTS_FAILED = 'fetching-events-failed'
